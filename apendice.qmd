...
Se usará un extracto de los datos de la prueba de admisión a la facultad de medicina (`dataMedicaltest`) de la librería `ShinyItemAnalysis` de @martinkova2016. El cual contiene las respuestas de $2,392$\$2,392\$ evaluados en una prueba de $100$ preguntas de opción múltiple.
